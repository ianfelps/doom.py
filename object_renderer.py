...
class ObjectRenderer:
    ...
    def draw_enemies_remaining(self):
        enemies_remaining = str(self.game.object_handler.enemies_alive)
        for i, char in enumerate(enemies_remaining[::-1]):
            self.screen.blit(self.digits[char], (WIDTH - (i + 1) * self.digit_size, 0))
